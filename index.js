...
var Typer = {
    ...
    addText: function (key) {
        // TODO: skip writing comments to the console div. i have some long comments and because 
        // this is literally just copying text from one file into another file
        // at a certain rate, comments are included in this time.
        if (key.keyCode == 18) {
            Typer.accessCount++;
    ...
    flipCursor: function () {
        ...
        // if (cont[cont.length - 1] == '|') {
        //     $('#console').html(
        //         $('#console').html().substring(0, cont.length - 1) + '<br>',
        //     );
        // } else if (cont.substring(cont.length - 4, cont.length) == '<br>') {
        //     $('#console').html(
        //         $('#console').html().substring(0, cont.length - 4) + '|',
        //     );
        // } else {
        //     console.log("error the last character was: " + cont.substring(cont.length - 4, cont.length))
        // }
    }
}
